...
class RentalsControllerTest < ActionController::TestCase
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post :create, rental: { rentable_id: @rental.rentable_id, user_id: @rental.user_id }
    end
  ...
  test "should update rental" do
    patch :update, id: @rental, rental: { rentable_id: @rental.rentable_id, user_id: @rental.user_id }
    assert_redirected_to rental_path(assigns(:rental))
  end
